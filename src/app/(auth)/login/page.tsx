  ...
  return (
    <div className="w-full">
      ...
      <div className="lg:hidden mb-8">
        ...
        <p className="text-[14px] text-white/35 mt-2">운동 기록을 이어가세요</p>
      </div>
      ...
      <div className="hidden lg:block mb-10">
        ...
        <h1 className="text-[24px] font-bold text-white">로그인</h1>
        <p className="text-[13px] text-white/35 mt-1.5">운동 기록을 이어가세요</p>
      </div>
      ...
      <p className="text-center text-[13px] text-white/30 mt-8">
        계정이 없으신가요?{" "}
        <Link href="/register" className="text-[#00FF87] hover:text-[#00FF87]/80 transition-colors font-semibold">
          가입하기
        </Link>
      </p>
    </div>
