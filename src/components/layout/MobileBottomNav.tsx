...
export default function MobileBottomNav() {
  ...
  return (
    <nav className="lg:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#09090B]/95 backdrop-blur-xl border-t border-white/[0.04]">
        ...
        {navItems.map((item) => {
          ...
          if (item.isAction) {
            return (
              ...
              >
                <div className="w-10 h-10 rounded-full bg-[#6366F1] flex items-center justify-center shadow-[0_2px_12px_rgba(99,102,241,0.25)]">
          ...
          return (
            ...
            >
              <span className={isActive ? "text-[#6366F1]" : "text-white/25"}>{item.icon}</span>
